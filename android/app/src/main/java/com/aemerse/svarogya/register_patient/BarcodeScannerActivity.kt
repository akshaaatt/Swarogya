...
class BarcodeScannerActivity : AppCompatActivity(), OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        overridePendingTransition(com.aemerse.svarogya.R.anim.slide_in_up, com.aemerse.svarogya.R.anim.slide_out_up)
                    ...
                    if(task.result!!.size()==0){
                        ...
                        if (userHere == "regular" && !treatmentDoc.contains("phoneNumber")) {
                            MaterialDialog(this).show {
                                ...
                                icon(com.aemerse.svarogya.R.drawable.ic_data_transfer_30dp, null)
                                message(null, "Joining with ${treatmentDoc.getString("hospitalName")}")
                                positiveButton(com.aemerse.svarogya.R.string.accept) {
                                            ...
                                            FirebaseFirestore.getInstance().collection("OngoingTreatments")
                                                ...
                                                .update("bloodGroup",userDoc.get("bloodGroup")
                                                    ...
                                                    getSharedPreferences(sharedPrefFile, Context.MODE_PRIVATE).commit {
                                                        putString(getString(com.aemerse.svarogya.R.string.currentPatientId),treatmentDoc.getString("patientId"))
                                                    }
                                ...
                                negativeButton(com.aemerse.svarogya.R.string.cancel) {
                                    finish()
                                }
                                debugMode(false)
                                ...
                                .getString(getString(com.aemerse.svarogya.R.string.professionalHospitalName),null) == treatmentDoc.getString("hospitalName")){
